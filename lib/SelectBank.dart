                  ...
                  Pinned.fromPins(
                    ...
                    child:
                      ...
                      children: <Widget>[
                        ...
                        Pinned.fromPins(
                          ...
                          child:
                            ...
                            children: <Widget>[
                              ...
                              Pinned.fromPins(
                                Pin(startFraction: 0.0514, endFraction: 0.8971),
                                Pin(size: 18.0, middle: 0.0429),
                                child:
                              ...
                              Pinned.fromPins(
                                ...
                                Pin(size: 36.0, middle: 0.0181),
                                child:
                                    // Adobe XD layer: 'Westpac Online Banki' (text)
                                    Text(
                                  'Westpac Online\nBanking Personal',
                                  style: TextStyle(
                                    fontFamily: 'Montserrat-Medium',
                                ...
                                child:
                                  ...
                                  children: <Widget>[
                                    ...
                                    Pinned.fromPins(
                                      ...
                                      Pin(size: 18.0, middle: 0.3297),
                                      child:
                                          // Adobe XD layer: 'American Express Car' (text)
                                          Text(
                                        'American Express Cards Bank',
                                        style: TextStyle(
                                          fontFamily: 'Montserrat-Medium',
                                          fontSize: 14,
                                          color: const Color(0xff0e131e),
                              ...
                              Pinned.fromPins(
                                Pin(startFraction: 0.0611, endFraction: 0.9068),
                              ...
                              Pinned.fromPins(
                                Pin(startFraction: 0.2058, endFraction: 0.3569),
                                Pin(size: 18.0, middle: 0.5),
                                child:
                                    // Adobe XD layer: 'Bankwest Personal' (text)
                                    Text(
                                  'Bankwest Personal',
                                  style: TextStyle(
                                    fontFamily: 'Montserrat-Medium',
                              ...
                              Pinned.fromPins(
                                Pin(startFraction: 0.0579, endFraction: 0.9035),
                                Pin(size: 18.0, middle: 0.7286),
                                child:
                              ...
                              Pinned.fromPins(
                                Pin(startFraction: 0.2058, endFraction: 0.2572),
                                Pin(size: 18.0, middle: 0.7286),
                                child:
                                    // Adobe XD layer: 'National Australia B' (text)
                                    Text(
                              ...
                              Pinned.fromPins(
                                Pin(startFraction: 0.2058, endFraction: 0.3344),
                                Pin(size: 18.0, middle: 0.9571),
                                child:
                                    // Adobe XD layer: 'ANZ Banking Group' (text)
                                    Text(
                                  'ANZ Banking Group',
                                  style: TextStyle(
                                    fontFamily: 'Montserrat-Medium',
                        ...
                        Pinned.fromPins(
                          Pin(startFraction: 0.363, endFraction: 0.363),
                          Pin(size: 18.0, middle: 0.0545),
                          child:
                              // Adobe XD layer: 'Select bank' (text)
                              Text.rich(
                            TextSpan(
                              style: TextStyle(
                                fontFamily: 'Montserrat-Medium',
                  ...
                  Pinned.fromPins(
                    ...
                    child:
                      ...
                      children: <Widget>[
                        ...
                        Pinned.fromPins(
                          Pin(startFraction: 0.1413, endFraction: 0.6107),
                          Pin(size: 19.0, middle: 0.8261),
                          child:
                              // Adobe XD layer: 'Search bank' (text)
                              Text(
                            'Search bank',
                            style: TextStyle(
...
const String _svg_cwz9d3 =
    '<svg viewBox="32.0 750.5 311.0 1.0" ><path transform="translate(32.0, 750.0)" d="M 0 0.5 L 311 0.5" fill="none" stroke="#d1d3d8" stroke-width="1" stroke-miterlimit="10" stroke-linecap="square" /></svg>';
