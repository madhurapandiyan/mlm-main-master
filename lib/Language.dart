                ...
                Pinned.fromPins(
                  ...
                  child:
                    ...
                    children: <Widget>[
                      ...
                      Pinned.fromPins(
                        Pin(startFraction: 0.07, endFraction: 0.8367),
                        Pin(size: 18.0, middle: 0.2201),
                        child:
                            // Adobe XD layer: 'Eng' (text)
                            Text(
                          'Eng',
                          style: TextStyle(
                      ...
                      Pinned.fromPins(
                        Pin(startFraction: 0.07, endFraction: 0.8367),
                        Pin(size: 18.0, middle: 0.4375),
                        child:
                            // Adobe XD layer: 'Por' (text)
                            Text(
                          'Por',
                          style: TextStyle(
                            fontFamily: 'Montserrat-Medium',
                      ...
                      Pinned.fromPins(
                        Pin(startFraction: 0.0758, endFraction: 0.8426),
                        Pin(size: 18.0, middle: 0.6549),
                        child:
                            // Adobe XD layer: 'jpn' (text)
                            Text(
                          'jpn',
                          style: TextStyle(
                            fontFamily: 'Montserrat-Medium',
                      ...
                      Pinned.fromPins(
                        Pin(size: 42.0, middle: 0.2658),
                        Pin(size: 19.0, middle: 0.6512),
                        child:
                            // Adobe XD layer: 'Group 4' (group)
                            Stack(
                          children: <Widget>[
                      ...
                      Pinned.fromPins(
                        Pin(startFraction: 0.07, endFraction: 0.8338),
                        Pin(size: 18.0, middle: 0.8723),
                        child:
                            // Adobe XD layer: 'chn' (text)
                            Text(
                          'chn',
                          style: TextStyle(
                            fontFamily: 'Montserrat-Medium',
                      ...
                      Pinned.fromPins(
                        Pin(size: 28.0, middle: 0.254),
                        Pin(size: 19.0, end: 48.0),
                        child:
                            // Adobe XD layer: 'Group 4' (group)
                            Stack(
                          children: <Widget>[
                      ...
                      Pinned.fromPins(
                        ...
                        Pin(size: 18.0, middle: 0.087),
                        child:
                            // Adobe XD layer: 'Select languages' (text)
                            Text.rich(
                          TextSpan(
                            style: TextStyle(
                              fontFamily: 'Montserrat-Medium',
                ...
                Pinned.fromPins(
                  ...
                  child:
                    ...
                    children: <Widget>[
                      ...
                      Pinned.fromPins(
                        Pin(startFraction: 0.1413, endFraction: 0.5013),
                        Pin(size: 19.0, middle: 0.8261),
                        child:
                            // Adobe XD layer: 'Search languages' (text)
                            Text(
                          'Search languages',
                          style: TextStyle(
...
const String _svg_o86ufv =
    '<svg viewBox="16.0 129.5 311.0 1.0" ><path transform="translate(16.0, 129.0)" d="M 0 0.5 L 311 0.5" fill="none" stroke="#d1d3d8" stroke-width="1" stroke-miterlimit="10" stroke-linecap="square" /></svg>';
...
const String _svg_vr6xwl =
    '<svg viewBox="16.0 289.5 311.0 1.0" ><path transform="translate(16.0, 289.0)" d="M 0 0.5 L 311 0.5" fill="none" stroke="#d1d3d8" stroke-width="1" stroke-miterlimit="10" stroke-linecap="square" /></svg>';
