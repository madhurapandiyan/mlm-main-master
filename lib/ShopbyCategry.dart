...
import './ElectronicsGadgets.dart';
import 'package:adobe_xd/page_link.dart';
import 'package:flutter_svg/flutter_svg.dart';

class ShopbyCategry extends StatelessWidget {
  ShopbyCategry({
    Key? key,
  }) : super(key: key);
  @override
            ...
            child: PageLink(
              links: [
                PageLinkInfo(
                  ...
                  ease: Curves.easeOut,
                  duration: 0.3,
                  pageBuilder: () => ElectronicsGadgets(),
                ),
              ],
              child: Stack(
                children: <Widget>[
                  ...
                  Pinned.fromPins(
                    ...
                    child: Stack(
                      children: <Widget>[
                        Pinned.fromPins(
                          Pin(start: -26.4, end: 0.0),
                          Pin(start: -59.2, end: -19.8),
                          child:
                  ...
                  Pinned.fromPins(
                    ...
                    child: Stack(
                      children: <Widget>[
                        Pinned.fromPins(
                          Pin(start: -19.0, end: -27.0),
                          Pin(start: -2.0, end: -1.5),
                          child:
                              // Adobe XD layer: 'scattered-beer-snac…' (shape)
                              Container(
                            decoration: BoxDecoration(
                              image: DecorationImage(
                                image: const AssetImage(''),
